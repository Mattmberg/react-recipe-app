...
export const recipeData = [
    ...
    },
    {
        ...
        name:"Scrambled Eggs",
        category: "Main",
        cookInstructions: ["Crack the eggs into a bowl for mixing.", "Beat the eggs until everything is mixed well.", "Pour into hot pan on stove for cooking.", "Cook until solidified and none of the egg looks wet.", "Take out of pan to cool then serve."],
        cookTemp: "",   
        description: "",
    ...
    },
    {
        ...
        category: "Main",
        cookInstructions: ["Crack the eggs into a mixing bowl.", ""],
        description: "",
